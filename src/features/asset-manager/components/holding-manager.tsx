...
export default function HoldingManager({ holdings, assets, brokers }: HoldingManagerProps) {
  ...
  const getAssetName = (id: string) => assets.find(a => a.id === id)?.symbol || id;
            ...
            <form onSubmit={handleCreate} className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                    ...
                    onValueChange={(v) => setNewHolding({...newHolding, broker_id: v})}
                >
                    <SelectTrigger>
          ...
          <TableBody>
            {holdings.map((holding) => (
              <TableRow key={holding.id}>
                <TableCell className="font-medium">{getAssetName(holding.asset_id)}</TableCell>
                ...
                <TableCell>
                  <Button
                    ...
                    onClick={() => {
                        if(confirm('Delete this holding?')) deleteHolding.mutate(holding.id)
                    }}
                  >
